...
namespace ScheduleProg.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Discipline_Name")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Discipline_Name")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
