...
namespace ScheduleProg.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,First_Name,Last_Name")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,First_Name,Last_Name")] Teacher teacher)
        {
            if (id != teacher.Id)
            {
                return NotFound();
